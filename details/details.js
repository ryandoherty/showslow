...
YAHOO.util.Event.onDOMReady(function() {
	...
	var loader = new YAHOO.util.YUILoader({
		...
		var yDataSource = new YAHOO.util.DataSource("/details/data.php?subset=table&");
		...
		var psDataSource = new YAHOO.util.DataSource("/details/data_pagespeed.php?subset=table&");
		...
		var dtDataSource = new YAHOO.util.DataSource("/details/data_dynatrace.php?subset=table&");
